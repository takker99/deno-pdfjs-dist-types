...
export class PDFFindController {
    ...
    _linkService: import("./interfaces.d.ts").IPDFLinkService;
    _eventBus: import("./event_utils.d.ts").EventBus;
    ...
    _pdfDocument: import("../src/display/api.d.ts").PDFDocumentProxy | null | undefined;
    /**
     * @private
     */
    private _onFind;
