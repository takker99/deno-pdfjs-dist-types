...
export type PDFFindController = import("./pdf_find_controller.d.ts").PDFFindController;
...
/** @typedef {import("./pdf_find_controller.d.ts").PDFFindController} PDFFindController */
/**
...
export class TextHighlighter {
    ...
    findController: import("./pdf_find_controller.d.ts").PDFFindController;
    matches: any[];
