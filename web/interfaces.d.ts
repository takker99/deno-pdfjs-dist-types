...
export type PageViewport =
  import("../src/display/display_utils.d.ts").PageViewport;
export type AnnotationLayerBuilder =
  import("./annotation_layer_builder.d.ts").AnnotationLayerBuilder;
export type EventBus = import("./event_utils.d.ts").EventBus;
export type StructTreeLayerBuilder = any;
export type TextHighlighter = import("./text_highlighter.d.ts").TextHighlighter;
export type TextLayerBuilder =
  import("./text_layer_builder.d.ts").TextLayerBuilder;
export type RenderingStates = any;
export type XfaLayerBuilder =
  import("./xfa_layer_builder.d.ts").XfaLayerBuilder;
/**
 * @interface
 */
...
/** @typedef {import("../src/display/api.d.ts").PDFPageProxy} PDFPageProxy */
/** @typedef {import("../src/display/display_utils.d.ts").PageViewport} PageViewport */
/** @typedef {import("./annotation_layer_builder.d.ts").AnnotationLayerBuilder} AnnotationLayerBuilder */
/** @typedef {import("./event_utils.d.ts").EventBus} EventBus */
/** @typedef {import("./struct_tree_builder.d.ts").StructTreeLayerBuilder} StructTreeLayerBuilder */
/** @typedef {import("./text_highlighter.d.ts").TextHighlighter} TextHighlighter */
/** @typedef {import("./text_layer_builder.d.ts").TextLayerBuilder} TextLayerBuilder */
/** @typedef {import("./ui_utils.d.ts").RenderingStates} RenderingStates */
/** @typedef {import("./xfa_layer_builder.d.ts").XfaLayerBuilder} XfaLayerBuilder */
/**
 * @interface
 */
