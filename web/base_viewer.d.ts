export type PDFDocumentProxy = import("../src/display/api.d.ts").PDFDocumentProxy;
export type PDFPageProxy = import("../src/display/api.d.ts").PDFPageProxy;
export type PageViewport = import("../src/display/display_utils.d.ts").PageViewport;
export type EventBus = import("./event_utils.d.ts").EventBus;
export type IDownloadManager = import("./interfaces.d.ts").IDownloadManager;
export type IL10n = import("./interfaces.d.ts").IL10n;
export type IPDFAnnotationLayerFactory = import("./interfaces.d.ts").IPDFAnnotationLayerFactory;
export type IPDFLinkService = import("./interfaces.d.ts").IPDFLinkService;
export type IPDFStructTreeLayerFactory = import("./interfaces.d.ts").IPDFStructTreeLayerFactory;
export type IPDFTextLayerFactory = import("./interfaces.d.ts").IPDFTextLayerFactory;
export type IPDFXfaLayerFactory = import("./interfaces.d.ts").IPDFXfaLayerFactory;
export type PDFViewerOptions = {
     ...
     * component.
     */
    downloadManager?: import("./interfaces.d.ts").IDownloadManager | undefined;
    /**
     * - The find controller
     * component.
     */
...
export class BaseViewer implements IPDFAnnotationLayerFactory, IPDFStructTreeLayerFactory, IPDFTextLayerFactory, IPDFXfaLayerFactory {
    ...
    container: HTMLDivElement;
    viewer: Element | null;
    eventBus: import("./event_utils.d.ts").EventBus;
    linkService: import("./interfaces.d.ts").IPDFLinkService;
    downloadManager: import("./interfaces.d.ts").IDownloadManager | null;
    findController: any;
    ...
    maxCanvasPixels: number | undefined;
    l10n: import("./interfaces.d.ts").IL10n;
    ...
    pdfDocument: import("../src/display/api.d.ts").PDFDocumentProxy | undefined;
    _scrollMode: any;
