...
export type IPDFXfaLayerFactory = import("./interfaces.d.ts").IL10n;
export type IRenderableView = import("./interfaces.d.ts").IRenderableView;
...
export class PDFPageView implements IRenderableView {
    ...
    rotation: number;
    scale: number;
    viewport: import("../src/display/display_utils.d.ts").PageViewport;
    ...
    textLayerFactory: import("./interfaces.d.ts").IPDFTextLayerFactory;
    annotationLayerFactory: import("./interfaces.d.ts").IPDFAnnotationLayerFactory;
    xfaLayerFactory: import("./interfaces.d.ts").IL10n;
    textHighlighter: any;
    structTreeLayerFactory: import("./interfaces.d.ts").IPDFStructTreeLayerFactory;
    renderer: string;
