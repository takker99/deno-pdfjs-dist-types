...
export function loadScript(
  src: string,
  removeScriptElement?: boolean | undefined,
): Promise<void>;
/**
...
export class PageViewport {
   ...
   */
  constructor(
    { viewBox, scale, rotation, offsetX, offsetY, dontFlip }:
...
export class RenderingCancelledException
  extends RenderingCancelledException_base {
  [x: string]: any
...
import { BaseCanvasFactory } from "./base_factory.d.ts";
import { BaseCMapReaderFactory } from "./base_factory.d.ts";
import { BaseStandardFontDataFactory } from "./base_factory.d.ts";
import { BaseSVGFactory } from "./base_factory.d.ts";
export {};
