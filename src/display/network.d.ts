...
declare class PDFNetworkStreamFullRequestReader implements IPDFStreamReader {
    ...
    _url: any;
    _fullRequestId: any;
    _headersReceivedCapability: import("../shared/util.d.ts").PromiseCapability;
    _disableRange: any;
    _contentLength: any;
    _rangeChunkSize: any;
    ...
    _requests: any[];
    _done: boolean;
    _storedError: import("../shared/util.d.ts").MissingPDFException | import("../shared/util.d.ts").UnexpectedResponseException | undefined;
