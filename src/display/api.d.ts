...
export const DefaultStandardFontDataFactory:
  | typeof DOMStandardFontDataFactory
  | {
    new (): {};
  };
/**
...
export class PDFDocumentLoadingTask {
  ...
  _capability: import("../shared/util.d.ts").PromiseCapability;
  _transport: any;
  _worker: any;
  /**
...
export class PDFPageProxy {
   ...
   */
  getOperatorList(
    { intent, annotationMode }?: GetOperatorListParameters,
...
import { PageViewport } from "./display_utils.d.ts";
import { OptionalContentConfig } from "./optional_content_config.d.ts";
import { DOMCanvasFactory } from "./display_utils.d.ts";
import { DOMCMapReaderFactory } from "./display_utils.d.ts";
import { DOMStandardFontDataFactory } from "./display_utils.d.ts";
import { AnnotationStorage } from "./annotation_storage.d.ts";
import { info } from "../shared/util.d.ts";
import { Metadata } from "./metadata.d.ts";
import { StatTimer } from "./display_utils.d.ts";
/**
...
import { MessageHandler } from "../shared/message_handler.d.ts";
export {};
