export type PDFPageProxy = import("./api.d.ts").PDFPageProxy;
export type PageViewport = import("./display_utils.d.ts").PageViewport;
export type IDownloadManager = any;
export type IPDFLinkService =
  import("../../web/interfaces.d.ts").IPDFLinkService;
...
export class AnnotationLayer {
  ...
  static "__#4@#setAnnotationCanvasMap"(
    div: any,
